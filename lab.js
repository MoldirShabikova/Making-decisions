...
if(temperature < 80 && rain){
  ...
  console.log('Its a nice weather today')
}else {
  console.log(`Go to a walk`)
}
////////// PROBLEM 5 //////////
...
////////// PROBLEM 10 //////////
// Using the "not" operator (!), change the current value of changeMyMind to true (it should currently 
//be set to false due to the if-else statement in Problem 9). 
